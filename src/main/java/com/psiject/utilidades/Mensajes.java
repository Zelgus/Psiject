...
public class Mensajes {
   ...
   public static void mostrarMensajeAlerta(final String mensaje) {
      ...
      FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, null, mensaje));
      FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
   }

   public static void mostrarMensajeError(final String mensaje, final Exception e) {
